...
- [ ] Why would you use class component over function components (removing hooks from the question)?
    ...
    Class Components are useful to learn in-case you have to work with legacy applications.
...
- [ ] What is the purpose of a custom hook?
    ...
    Custom hooks are important, because they allow you to reuse stateful logic within your application.

- [ ] Why is it important to test our apps?

    Testing apps is important to make sure the functionality of our app meets a certain standard before publication.
